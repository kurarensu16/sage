        ...
        <div className="flex items-center gap-2 border-b border-slate-200 pb-3 sm:pb-4 overflow-x-auto">
          {['All', 'Unread', 'System'].map(filter => (
            <button
              ...
              className={cn(
                "px-3.5 py-1.5 text-xs font-semibold rounded-full border transition-colors cursor-pointer whitespace-nowrap",
                activeFilter === filter 
          ...
          {filtered.length > 0 ? (
            filtered.map((noti) => (
              <div 
                key={noti.id} 
                className={cn(
                  "p-3.5 sm:p-5 rounded-2xl border transition-all flex items-start justify-between gap-3 sm:gap-4 group",
                  noti.read 
              ...
              >
                ...
                <div className="flex gap-3 sm:gap-4 min-w-0 flex-1">
                  {/* Icon Card */}
                  <div className={cn(
                    "p-2 sm:p-2.5 rounded-xl border w-9 h-9 sm:w-10 sm:h-10 flex-shrink-0 flex items-center justify-center",
                    noti.iconColor
                  )}>
                  ...
                  <div className="space-y-1 min-w-0 flex-1">
                    <div className="flex items-center gap-2">
                      <h4 className={cn(
                        "text-xs sm:text-sm font-bold text-slate-900 leading-snug",
                    ...
                    <p className="text-xs text-slate-655 leading-relaxed text-left break-words">{noti.message}</p>
