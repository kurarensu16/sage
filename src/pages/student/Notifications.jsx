  ...
  return (
    <>
      <PageHeader title="My Notifications" breadcrumb="Student Portal">
        <button 
          onClick={markAllRead}
          className="w-full sm:w-auto px-3.5 py-2 text-xs font-semibold border border-slate-200 text-slate-700 hover:border-sage-300 rounded-xl transition-colors bg-white flex items-center justify-center gap-2 cursor-pointer shadow-sm"
        >
          <MailOpen className="h-4 w-4 text-slate-500" /> Mark all as read
        </button>
      </PageHeader>

      <div className="p-4 sm:p-6 md:p-8 overflow-y-auto flex-1 max-w-4xl mx-auto w-full space-y-4 sm:space-y-6">
