  ...
  return (
    <>
      <PageHeader title="Log Class Attendance" breadcrumb="Faculty Portal">
        ...
        {saveStatus === 'error' && (
          <span className="flex items-center gap-1.5 text-xs text-rose-600 bg-rose-50 px-3 py-1.5 rounded-lg border border-rose-200 font-semibold">
        ...
        {isInitialized && (
          <button 
            ...
            className="px-4 py-2 text-sm font-medium border border-slate-200 text-slate-700 hover:border-sage-300 rounded-lg transition-colors bg-white flex items-center gap-2 cursor-pointer"
          >
        ...
        {isInitialized && (
          <button 
            ...
            className="px-4 py-2 text-sm font-semibold text-white bg-sage-600 hover:bg-sage-700 rounded-lg shadow-sm transition-all flex items-center gap-1.5 cursor-pointer"
          >
      ...
      {toastMessage && (
        <div className="fixed top-20 right-8 z-50 animate-in fade-in slide-in-from-top-3 duration-200">
      ...
      <div className="p-8 overflow-y-auto flex-1 space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-4 p-4 rounded-xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Session Tally</p>
        ...
        {previousSessions.length > 0 && (
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 shadow-sm space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px] text-slate-400 font-medium">{previousSessions.length} logged session{previousSessions.length !== 1 ? 's' : ''}</span>
            </div>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-amber-900 text-xs flex items-start gap-3 shadow-sm">
          <AlertTriangle className="h-4.5 w-4.5 text-amber-600 flex-shrink-0 mt-0.5" />
          <div className="space-y-0.5">
            <span className="font-bold">Failure Due to Absences (FDA) Institutional Policy:</span>
            ...
            <div className="p-4 border-b border-slate-200 bg-slate-50/70 flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="relative flex-1 min-w-[220px] max-w-sm">
                ...
                <input
                  ...
                  className="w-full pl-8 pr-8 py-1.5 bg-white border border-slate-200 rounded-lg text-xs font-medium focus:ring-1 focus:ring-sage-500 focus:border-sage-500 outline-none transition-all"
                />
                {searchQuery && (
                  <button 
              ...
              <div className="flex items-center gap-1.5 flex-wrap">
                {[
                  ...
                  { id: 'fda', label: `FDA Alert (${fdaCount})`, icon: ShieldAlert }
                ].map(filter => {
          ...
          {loading ? (
            ...
            <div className="p-12 text-center max-w-md mx-auto space-y-4">
              ...
              <button
                ...
                className="px-6 py-2.5 bg-sage-600 hover:bg-sage-700 text-white font-semibold rounded-xl shadow-sm transition-all cursor-pointer inline-flex items-center gap-2"
              >
